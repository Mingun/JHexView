...
public class JCaret
{
  ...
  /**
   * Creates a new caret with a custom blink period and the default caret color
   * red.
   *
   * @param blinkPeriod
   ...
   *
   * @throws NullPointerException
   *           Thrown if the passed listener is null.
   */
   ...
   * @return The currently assigned caret color.
   */
  ...
  /**
   * Class of internal listeners that are used to hide the callback functions
